...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|MICHAEL|JUNIOR|THERASYAD|❤',
...
const musicOptions = [
    { value: './music/happybirthday.mp3', label: 'Happy Birthday (Miễn phí)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday (Phiên bản 2)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday (Độ Mixi)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday (Mèo UIA)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday (Instrumental)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday Podcast (Nam)' },
    { value: './music/happybirthday.mp3', label: 'Happy Birthday Podcast (Nữ)' },
    { value: './music/happybirthday.mp3', label: 'Give Me Your Forever' },
    { value: './music/happybirthday.mp3', label: 'Perfect' },
    { value: './music/happybirthday.mp3', label: 'Phép màu' },
    { value: './music/happybirthday.mp3', label: 'Làm bạn trai anh nhé' },
    { value: './music/happybirthday.mp3', label: 'Đến bên anh' },
    { value: './music/happybirthday.mp3', label: 'Ánh nắng của anh' },
    { value: './music/happybirthday.mp3', label: 'Đừng làm trái tim anh đau' },
    { value: './music/happybirthday.mp3', label: 'Bụi phấn' },
    { value: './music/happybirthday.mp3', label: 'Bước nhẹ vào tim anh' },
    { value: './music/happybirthday.mp3', label: 'Có đôi điều' },
    { value: './music/happybirthday.mp3', label: 'Có em' },
    { value: './music/happybirthday.mp3', label: 'Em này' },
    { value: './music/happybirthday.mp3', label: 'Em là cô giáo vùng cao' },
    { value: './music/happybirthday.mp3', label: 'Em là cô giáo vùng cao (Remix)' },
    { value: './music/happybirthday.mp3', label: 'Lá thư gửi thầy' },
    { value: './music/happybirthday.mp3', label: 'Lời thầy cô' },
    { value: './music/happybirthday.mp3', label: 'Người thầy' },
    { value: './music/happybirthday.mp3', label: 'Người gieo mầm xanh' },
    { value: './music/happybirthday.mp3', label: 'Người đầu tiên' },
    { value: './music/happybirthday.mp3', label: 'Một đời' },
    { value: './music/happybirthday.mp3', label: 'Mình cùng nhau đóng băng' },
    { value: './music/happybirthday.mp3', label: 'Nếu như có hai trái tim' },
    { value: './music/happybirthday.mp3', label: 'Ngày xưa ấy' },
    { value: './music/happybirthday.mp3', label: 'Như 1 vì tinh tú' },
    { value: './music/happybirthday.mp3', label: 'Tình yêu diệu kỳ' },
    { value: './music/happybirthday.mp3', label: 'Trên tình bạn dưới tình yêu' },
    { value: './music/happybirthday.mp3', label: 'Từng ngày yêu em' },
    { value: './music/happybirthday.mp3', label: 'Yêu em rất nhiều' },
    { value: './music/happybirthday.mp3', label: 'Suy nghĩ trong anh' }
];
const gifOptions = [
    { value: '', label: 'None' },
...
function updatePricingFromModal() {
    if (window.pricingCalculator) {
        const currentModalSettings = {
            music: document.getElementById('backgroundMusic')?.value || './music/happybirthday.mp3',
...
if (languageSwitchBtn) {
    ...
    try {
        ...
        if (result.success && result.data) {
            ...
            window.settings = {
                music: serverSettings.music || './music/happybirtday.mp3',
...
function tryStartWebsiteWhenLandscape() {
    // Kita hapus syarat 'window.isWebsiteReady'
    // Cukup cek apakah fungsi startWebsite tersedia
    if (typeof startWebsite === 'function') {
        if (isLandscapeMode()) {
            startWebsite();
        } else {
            // Jika masih portrait, tunggu sampai dimiringkan
